    ...
    <main className="lg:max-w-[1450px] w-full ">
      <header className="fixed top-0 left-0 w-full z-[99999999] bg-black  font-clash text-white">
        <div className="flex items-center justify-between p-5 ml-4 mr-4">
          <div>
            <h1 className="font-bold text-4xl cursor-pointer text-pretty text-purple-700 ">
              Shabnam
            </h1>
          </div>
          <div>
            <ul className="hidden lg:flex items-center justify-between gap-10">
              <li className="cursor-pointer text-2xl relative group font-medium">
                About
              ...
              <button className="w-[180px] h-[50px] bg-purple-700 text-white rounded-full border-0 outline-none cursor-pointer relative shadow-lg overflow-hidden group">
