          ...
          <form className="w-full max-w-[700px] flex flex-col gap-5 font-playfair font-semibold">
            <div className="w-full">
              ...
              <input
                type="text"
                id="name"
                className="border-2 border-black rounded-full py-2.5 px-4 w-full outline-none bg-[#201F20]"
              />
            </div>
            <div className="w-full ">
              <label
            ...
            <div>
              ...
              <textarea
                id="message"
                rows="5"
                className="border-2 border-black rounded-3xl py-2.5 px-4 w-full outline-none resize-none bg-[#201F20]"
              ></textarea>
            </div>
            <a
              href="mailto:mammadovaashabnamm@gmail.com"
